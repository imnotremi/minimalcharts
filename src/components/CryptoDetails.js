...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed z-20 top-0 w-full h-full bg-gray-200 bg-opacity-40 backdrop-blur-sm 
    ...
    >
      <div
        className="rounded-2xl xl:w-[65%] lg:w-[75%] md:w-[90%] sm:w-[75%] w-[90%] lg:h-[75%] md:h-[70%] h-[90vh] 
        scrollbar-thin md:overflow-hidden scrollbar-thumb-gray-200 scrollbar-track-gray-100 overflow-x-hidden 
        bg-white bg-opacity-100 rounded-lg text-black relative"
          ...
          <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
            <div className="flex flex-col  md:w-[45%] w-full h-full pr-2">
              <div className="flex w-full items-center ">
                ...
                <span className="text-md font-semibold py-0.5 px-2.5 ml-2 bg-[#0dd7ff] text-[#00a2ff] rounded-2xl bg-opacity-25 uppercase">
                  {data.symbol}
                </span>
              </div>
              ...
              <div className="flex w-full  mt-4 justify-between sm:flex-row flex-col">
                <div className="flex flex-col">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm bg-white text-gray-100 px-1.5 py-0.5  my-1 rounded"
                  >
                ...
                <div className="flex flex-col content-start sm:mt-0 mt-1">
                  ...
                  <div
                    className={`text-sm w-fit px-1 my-1 font-medium flex items-center bg-green text-green rounded bg-opacity-25 uppercase`}
                  >
                    <span>
                  ...
                  <div
                    className={`w-fit text-sm px-1 my-1 font-medium flex items-center bg-red text-red rounded bg-opacity-25 uppercase`}
                  >
                    <span>
