...
const handleCurrencySubmit = (e) => {
  ...
  return (
    <div className="mt-3 w-full text-black lg:h-12 h-full lg:border rounded-2xl 
   flex lg:flex-row
      ...
      <div className="flex lg:mr-7 justify-between mt-4 lg:mt-0 sm:flex-row flex-col relative">
        <form className="relative flex items-center font-nunito md:mr-12 mr-1" onSubmit={handleCurrencySubmit}>
          ...
          <input
            ...
            ref={currencyRef}
            placeholder="usd"
            className="rounded-2xl w-16 bg-gray-50 placeholder:text-gray-100  placeholder:text-base required outline-0 
    border border-transparent focus:border-black leading-4  sm:text-base text-sm sm:p-0 sm:pl-2 p-1
    "
          />
        ...
        >
          ...
          <select
            name="sortby"
            id="sortby"
            className="rounded-2xl bg-gray-50 sm:text-base text-sm pl-2 pr-10 py-1.5 focus:outline-0 text-transparent appearance-none capitalize leading-4
            w-full sm:w-48
            "
          onClick={handleSort}
          >
