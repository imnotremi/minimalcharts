      ...
      <div className="flex flex-col  border border-gray-100 rounded   min-h-[60vh] ">
        {savedData ? (
          <table className="w-full table-auto">
            <thead className="capitalize text-base text-black font-medium border-b border-gray-100 ">
              <tr>
              ...
              {savedData &&
                savedData.map((data) => {
                  return (
                    <tr
                      key={data.id}
                      className="text-center text-black text-base border-b border-gray-100  hover:bg-white"
                    >
          ...
          <h1 className="min-h-[60vh] sm:text-lg text-md text-black flex items-center justify-center ">
